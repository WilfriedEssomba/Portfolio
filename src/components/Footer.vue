...
<footer class="text-center text-lg-start bg-body-dark text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
      ...
      <div>
        ...
        <a href="" class="me-4 text-reset">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-gitlab" viewBox="0 0 16 16">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);color: white;">
      ...
      <a class="text-reset fw-bold" href="#">ESSOMBA WILFRIED</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
